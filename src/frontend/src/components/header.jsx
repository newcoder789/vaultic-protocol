...
const Header = () => {
    ...
    return (
        <header className="flex justify-between items-center py-4 px-4 lg:px-20 ml-4">
            <img className='absolute top-0 left-0 opacity-60 -z-10 h-15 w-12 mt-5 ml-4' src='/images/logo.jpg' alt='logo' />
